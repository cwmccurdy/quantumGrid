...
def main(number_of_time_intervals, time_step):
    """This time dependent script allows the caller to pass in the number
    of time intervals and the size of the time step.

    Args:
        number_of_time_intervals (int): The number of time intervals to divide
        up our Crank-Nicolson propagation. Defaults to 300.
        time_step (int): The time step for the propagator. Defaults to 0.1 atu.
    """
    #
