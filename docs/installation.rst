...
To install quantumGrid, run this command in your terminal:

.. code-block:: console

    $ pip install quantumgrid

This is the preferred method to install quantumGrid, as it will always install the most recent stable release.
